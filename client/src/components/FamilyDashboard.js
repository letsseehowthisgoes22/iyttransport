  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ 
        ...
        {transports.length === 0 ? (
          <p>No transports scheduled</p>
        ) : (
          <div>
            {transports.filter(t => t.status === 'in-progress').length > 0 && (
              <div style={{ 
                ...
                <strong style={{ color: '#155724' }}>
                  🚗 Transport in progress - Live tracking active
                </strong>
              </div>
            )}
      ...
      <div style={{ marginBottom: '20px' }}>
        <h4>Family Member Transports</h4>
        {transports.length === 0 ? (
          <p>No transports scheduled for your family member</p>
        ) : (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      {latestUpdate && (
                        <div style={{ fontSize: '12px', color: '#666' }}>
                          ±{latestUpdate.accuracy}m accuracy
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <div style={{ 
              ...
              {locationUpdates.filter(update => update.transport_id == selectedTransportId).length === 0 && (
                <div style={{ color: '#666', fontStyle: 'italic', textAlign: 'center', padding: '20px' }}>
                  No location updates yet. Updates will appear here when transport begins.
                </div>
              )}
            </div>
          </div>
